...
- Claude, Codex, Antigravity, Grok, Kilo, Copilot, and Cursor can all consume curated YAML on the CLI
  static-fallback path
- Claude, Codex, Antigravity, Grok, Kilo, Copilot, and Cursor advanced catalogs also consume the same
  curated input
...
- `config/curated-model-catalogs.yaml.example` - human-curated CLI model catalog input example consumed by the current Claude/Codex/Antigravity/Grok/Kilo/Copilot/Cursor importer slices
