...
|-----|-------|--------|------|
| [036-separate-repository-maintenance-skills-from-runtime-delivered-skills](./036-separate-repository-maintenance-skills-from-runtime-delivered-skills.md) | Separate repository-maintenance skills from runtime-delivered skills | Proposed | 2026-08-28 |
...
| [018-separate-skill-library-content-from-runtime-execution-engine](./018-separate-skill-library-content-from-runtime-execution-engine.md) | Separate skill-library content from runtime execution engine | Accepted | 2026-03-24 |
...
*Last updated: 2026-08-28 (ADR-036 proposed a separate canonical root for repository-maintenance skills.)*
