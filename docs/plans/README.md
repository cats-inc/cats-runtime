...
|------|-------|--------|--------------|
| [PLAN-039](./PLAN-039-provider-selection-bootstrap-rollout.md) | Provider Selection Bootstrap Rollout | Implementation and validation in progress | [SPEC-030](../specs/SPEC-030-provider-selection-before-bootstrap-probes.md), [ADR-039](../decisions/039-use-selected-provider-config-as-the-resource-boundary.md) |
...
selection-first bootstrap rollout; implementation is in progress.)*
