...
|------|-------|--------|--------------|
| [PLAN-032](./PLAN-032-acp-agent-adapters-and-runtime-facade.md) | ACP Agent Adapters and Runtime ACP Facade | In Progress (Phase 2 Capability Bridge Complete; Phase 3 Codex ACP Pilot In Progress) | [SPEC-025](../specs/SPEC-025-acp-agent-adapters-and-runtime-facade.md), [ADR-031](../decisions/031-keep-acp-inside-agent-backend-and-model-runtime-acp-as-a-separate-facade.md), [ADR-026](../decisions/026-model-a2a-as-an-agent-backend-adapter.md) |
