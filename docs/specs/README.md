...
|------|-------|--------|--------------|
| [SPEC-028](./SPEC-028-provider-model-catalog-maintenance-skill.md) | Provider Model Catalog Maintenance Skill | Draft | Approved 2026-08-28, PLAN-037 pending; [ADR-036](../decisions/036-separate-repository-maintenance-skills-from-runtime-delivered-skills.md) |
