...
|------|-------|--------|--------------|
| [SPEC-031](./SPEC-031-provider-catalog-data-and-local-overrides.md) | Provider Catalog Data and Local Overrides | Draft — design only | [PLAN-040](../plans/PLAN-040-provider-catalog-data-and-local-overrides.md), [ADR-040](../decisions/040-use-data-driven-provider-catalogs-and-local-overrides.md) |
