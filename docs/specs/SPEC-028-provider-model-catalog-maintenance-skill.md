...
**2026-09-27 amendment:** the owner moved Kiro CLI from the shortlist group to the
full-catalog group. It now carries the complete `/model` picker list, including the `auto`
