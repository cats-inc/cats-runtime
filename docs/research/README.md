...
| Entry | Topic | Focus |
|-------|-------|-------|
| [2026-08-08-grok-cli-install-tier-probe](./2026-08-08-grok-cli-install-tier-probe.md) | Grok CLI install-tier probe | Upstream install paths and auth evidence plus a local Grok 1.0.0 version/help probe, with session and stream contracts deliberately left unclaimed |
