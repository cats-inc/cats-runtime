      ...
      id: 2,
        result: {
          tools: expect.arrayContaining([
            ...
            expect.objectContaining({ name: 'pool_status' }),
            expect.objectContaining({ name: 'management_diagnostics' }),
            expect.objectContaining({ name: 'resume_management_operation' }),
            expect.objectContaining({ name: 'discovery_status' }),
            ...
            expect.objectContaining({ name: 'discover_kiro_sessions' }),
            expect.objectContaining({ name: 'list_auggie_sessions' }),
            expect.objectContaining({ name: 'discover_auggie_sessions' }),
            expect.objectContaining({ name: 'list_opencode_sessions' }),
            expect.objectContaining({ name: 'discover_opencode_sessions' }),
            ...
            expect.objectContaining({ name: 'save_provider_selection' }),
            expect.objectContaining({ name: 'list_wakeups' }),
            expect.objectContaining({ name: 'read_wakeup' }),
            expect.objectContaining({ name: 'create_wakeup' }),
            expect.objectContaining({ name: 'cancel_wakeup' }),
            expect.objectContaining({ name: 'trigger_wakeup' }),
            ...
            expect.objectContaining({ name: 'publish_artifacts' }),
            expect.objectContaining({ name: 'inspect_repo_status' }),
            expect.objectContaining({ name: 'commit_changes' }),
            expect.objectContaining({ name: 'push_branch' }),
          ]),
        },
    });
