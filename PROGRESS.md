...
- [ ] No manual probe entrypoint, capability snapshot, or baseline compare yet for `PLAN-021`; this slice only lands the shared collector and adapter instrumentation seam
- [ ] No semantic-drift heuristics or hard upgrade/regression classification yet; later `PLAN-021` slices still need that follow-through
