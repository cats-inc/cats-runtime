...
- [ ] Add broader remote tool discovery beyond the current OpenClaw `tools.catalog` slice and stronger later-target semantic probes beyond the current OpenClaw gateway health/model checks and Agent SDK bridge provider-registry/model/streaming visibility coverage
