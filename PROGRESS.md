...
- [ ] Continue broadening provider health probes beyond the current transport-native API/local auth/model checks and provider-level tooling summaries, especially deeper agent-target semantics and richer remote tool discovery
